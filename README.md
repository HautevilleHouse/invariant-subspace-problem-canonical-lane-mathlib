# Invariant Subspace Problem — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/invariant-subspace-problem-canonical-lane-mathlib.git
cd invariant-subspace-problem-canonical-lane-mathlib
lake exe
lake build
```
