/-!
# invariant-subspace-problem-canonical-lane Lean migration boundary
...
`InvariantSubspaceProblemCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "invariant-subspace-problem-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/invariant-subspace-problem-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the invariant subspace problem: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["invariant-subspace-problem", "operator-theory", "functional-analysis", "banach-spaces", "spectral-theory", "mathematical-proof", "reproducibility", "canonical-lane", "local-to-global", "manifold-constrained"]
